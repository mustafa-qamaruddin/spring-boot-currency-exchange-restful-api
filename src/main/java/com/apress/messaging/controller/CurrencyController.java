...
public class CurrencyController {
    ...
    public ResponseEntity<CurrencyExchange> getLatest(
        @RequestParam(
            name="base",
            defaultValue = CurrencyExchange.BASE_CODE
        ) String base
    ) throws Exception {
        return new ResponseEntity<CurrencyExchange>(
            new CurrencyExchange(
                base,
                new SimpleDateFormat("yyyy-MM-dd").format(new Date()),
                service.calculateByCode(base, new Date())
            ),
            HttpStatus.OK
        );
    }
    ...
    public ResponseEntity<CurrencyExchange> getByDate(
        ...
        return new ResponseEntity<CurrencyExchange>(
            new CurrencyExchange(
                ...
                service.calculateByCode(base, date)
            ),
            HttpStatus.OK
        );
    }
    ...
    public ResponseEntity<CurrencyConversion> conversion(
    ...
    public ResponseEntity<CurrencyExchange> addNewRates(
